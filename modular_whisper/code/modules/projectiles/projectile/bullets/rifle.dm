...
/obj/projectile/bullet/rebar/healium/Initialize(mapload)
	. = ..()
	RegisterSignal(src, list(COMSIG_PROJECTILE_ON_SPAWN_DROP, COMSIG_PROJECTILE_ON_SPAWN_EMBEDDED), PROC_REF(on_spawn_embedded))
