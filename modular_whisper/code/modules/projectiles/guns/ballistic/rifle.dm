/obj/item/gun/ballistic/rifle
	...
	icon = 'modular_whisper/icons/obj/weapons/guns/wide_guns.dmi'
	icon_state = "sakhno"
	...
	fire_sound = 'modular_whisper/sound/items/weapons/gun/rifle/shot_heavy.ogg'
	fire_sound_volume = 90
	rack_sound = 'modular_whisper/sound/items/weapons/gun/rifle/bolt_out.ogg'
	bolt_drop_sound = 'modular_whisper/sound/items/weapons/gun/rifle/bolt_in.ogg'
	drop_sound = 'modular_whisper/sound/items/handling/gun/ballistics/rifle/rifle_drop1.ogg'
	pickup_sound = 'modular_whisper/sound/items/handling/gun/ballistics/rifle/rifle_pickup1.ogg'
	tac_reloads = FALSE
...
/obj/item/gun/ballistic/rifle/item_interaction(mob/living/user, obj/item/tool, list/modifiers)
	if(need_bolt_lock_to_interact && !bolt_locked && !istype(tool, /obj/item/weapon/knife))
...
/obj/item/gun/ballistic/rifle/boltaction/attack_self(mob/user)
	if(jammed)
		if(prob(unjam_chance))
			...
			playsound(user,'modular_whisper/sound/items/weapons/jammed.ogg', 75, TRUE)
			return FALSE
	return ..()
...
/obj/item/gun/ballistic/rifle/boltaction/harpoon
	...
	fire_sound = 'modular_whisper/sound/items/weapons/gun/sniper/shot.ogg'
...
/obj/item/gun/ballistic/rifle/sniper_rifle
	...
	icon = 'modular_whisper/icons/obj/weapons/guns/ballistic.dmi'
	icon_state = "sniper"
	lefthand_file = 'modular_whisper/icons/mob/inhands/weapons/guns_lefthand.dmi'
	righthand_file = 'modular_whisper/icons/mob/inhands/weapons/guns_righthand.dmi'
	...
	fire_sound = 'modular_whisper/sound/items/weapons/gun/sniper/shot.ogg'
	fire_sound_volume = 90
	load_sound = 'modular_whisper/sound/items/weapons/gun/sniper/mag_insert.ogg'
	rack_sound = 'modular_whisper/sound/items/weapons/gun/sniper/rack.ogg'
...
/obj/item/gun/ballistic/rifle/sniper_rifle/reset_fire_cd()
	. = ..()
	if(suppressed)
		playsound(src, 'modular_whisper/sound/machines/eject.ogg', 25, TRUE, ignore_walls = FALSE, extrarange = SILENCED_SOUND_EXTRARANGE, falloff_distance = 0)
	else
		playsound(src, 'modular_whisper/sound/machines/eject.ogg', 50, TRUE)
