...
/obj/item/ammo_casing/shotgun
	...
	custom_materials = list(/datum/material/iron=1*2)
...
/obj/item/ammo_casing/shotgun/beanbag
	...
	icon_state = "bshell"
	custom_materials = list(/datum/material/iron=1*2.5)
...
/obj/item/ammo_casing/shotgun/flechette
	...
	custom_materials = list(/datum/material/iron = 0.5, /datum/material/glass = 1 * 2)
	pellets = 8
	variance = 10
...
/obj/item/ammo_casing/shotgun/flechette/donk
	...
	custom_materials = list(/datum/material/iron = 0.5, /datum/material/plastic = 1 * 2)
	pellets = 5
