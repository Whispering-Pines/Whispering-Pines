...
/datum/species/plantoid
	...
	They are entirely made of plant matter and sustain themselves on sunlight, they have humanlike organs due to necessity of being almost human but are easier to delimb due lack of bone and overall pretty stupid and unable to speak or comprehend languages, animalistic a tad.<br><br>\
	...
	inherent_traits = list(TRAIT_NOMOBSWAP,TRAIT_APRICITY,TRAIT_SEEDKNOW,TRAIT_LANGUAGE_BARRIER,TRAIT_EASYDISMEMBER)
