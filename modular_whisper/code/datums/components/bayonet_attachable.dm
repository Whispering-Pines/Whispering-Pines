...
/datum/component/bayonet_attachable
	...
	var/static/list/valid_bayonets = typecacheof(list(/obj/item/weapon/knife))
...
/datum/component/bayonet_attachable/Initialize(
	...
	bayonet_overlay_icon = 'modular_whisper/icons/obj/weapons/guns/bayonets.dmi',
	allow_sawnoff = FALSE
)
...
/datum/component/bayonet_attachable/RegisterWithParent()
	...
	RegisterSignal(parent, COMSIG_ATOM_SCREWDRIVER_ACT, PROC_REF(on_screwdriver))
