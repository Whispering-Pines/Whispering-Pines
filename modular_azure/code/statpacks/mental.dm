...
/datum/statpack/mental/scholarly
	...
	stat_array =  list(STATKEY_INT = 2, STATKEY_PER = 1, STATKEY_STR = -1, STATKEY_END = -1)
...
/datum/statpack/mental/faithdriven
	...
	stat_array = list(STATKEY_INT = 1, STATKEY_CON = 1, STATKEY_END = 1, STATKEY_PER = -2)

/datum/statpack/mental/zealous
	name = "Zealous"
	desc = "Faith in something drives your body and mind to match what neither can see."
	stat_array = list(STATKEY_STR = 1, STATKEY_INT = 1, STATKEY_END = 1, STATKEY_PER = -1, STATKEY_SPD = -1)

/datum/statpack/mental/augury
	name = "Foresighted"
	desc = "You see what is and what will sometimes be."
	stat_array = list(STATKEY_PER = 2, STATKEY_INT = 1, STATKEY_STR = -1, STATKEY_END = -1)

/datum/statpack/mental/adept
	name = "Adept"
	desc = "Your will leads the way."
	stat_array = list(STATKEY_PER = 1, STATKEY_INT = 1, STATKEY_SPD = 1, STATKEY_STR = -1, STATKEY_CON = -1)

/datum/statpack/mental/aware
	name = "Aware"
	desc = "Your keen senses have not led you astray."
	stat_array = list(STATKEY_PER = 2, STATKEY_SPD = 1, STATKEY_END = -1, STATKEY_CON = -1)
...
/datum/statpack/mental/precise
	...
	stat_array = list(STATKEY_PER = 2, STATKEY_STR = 1, STATKEY_END = -1, STATKEY_CON = -1)

/datum/statpack/mental/diligent
	name = "Diligent"
	desc = "You take your time, but you have a lot of it to spare."
	stat_array =  list(STATKEY_INT = 2, STATKEY_END = 1, STATKEY_SPD = -1)

/datum/statpack/mental/industrious
	name = "Industrious"
	desc = "You waste no time. You know enough to get by, and strive towards it."
	stat_array =  list(STATKEY_INT = 2, STATKEY_SPD = 1, STATKEY_CON = -1, STATKEY_PER = -1)
