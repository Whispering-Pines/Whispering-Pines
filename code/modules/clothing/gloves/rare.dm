...
/obj/item/clothing/gloves/rare/zybanplate
	...
	desc = "Interwoven beautifully with layers of silk, chain and plate, these gauntlets grant unmatched coverage while allowing maximum mobility. Both useful to the Craterin's ever-growing slave-empire."
