...
/datum/mapGeneratorModule/forest
	...
	spawnableAtoms = list(
		...
		/obj/structure/flora/grass/thorn_bush/green = 6,
		...
		/obj/structure/flora/grass/bush_meagre/green = 4,
...
/datum/mapGeneratorModule/forestgrass
	...
	spawnableAtoms = list(
		/obj/structure/flora/grass = 80,
		/obj/structure/flora/grass/bush_meagre/green = 7,
		/obj/structure/flora/grass/herb/random = 6,
		/obj/item/grown/log/tree/stick = 5,
		/obj/structure/flora/grass/thorn_bush/green = 4,
