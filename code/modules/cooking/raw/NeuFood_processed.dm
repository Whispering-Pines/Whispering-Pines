...
/obj/item/reagent_containers/glass/bucket/wooden/attackby(obj/item/I, mob/living/user, params)
	...
	if(istype(I, /obj/item/kitchen/spoon))
		...
		if(do_after(user, long_cooktime, src))
			...
			user.adjust_experience(/datum/skill/craft/cooking, (user.STAINT))
		return
	..()
...
/obj/item/reagent_containers/food/snacks/jellycake_pear
	...
	desc = "A mildly unappetising dessert, fittingly considered a delicacy by orcs. This flavor is a strange fusion of Crater Emirate and Orcish cuisines."
