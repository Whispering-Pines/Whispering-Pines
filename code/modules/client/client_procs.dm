...
/client/proc/show_influences()
	...
	var/necra_followers = GLOB.patron_follower_counts["Last Death"] || 0
	...
	var/wanderer_storyteller = /datum/storyteller/ravox
	...
	var/matthios_followers = GLOB.patron_follower_counts["Dismas"] || 0
