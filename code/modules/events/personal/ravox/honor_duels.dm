...
/datum/round_event/ravox_duel/start()
	...
	to_chat(chosen_one, span_notice("Wanderer wants you to challenge others to honor duels! Win [new_objective.duels_required] duel\s to prove your worth! Duels end when a fighter yields or is knocked unconscious."))
