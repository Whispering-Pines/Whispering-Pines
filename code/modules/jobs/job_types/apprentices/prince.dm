/datum/job/prince
	...
	But someday you’ll have to grow up, and that will be the day your carelessness will cost you more than a few casings."
	flag = PRINCE
