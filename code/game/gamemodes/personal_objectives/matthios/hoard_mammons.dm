...
/datum/objective/hoard_mammons/proc/check_mammons()
	...
	if(mammon_count >= target_mammons && !completed)
		to_chat(user, span_greentext("You have accumulated [mammon_count] casings, completing Dismas' objective!"))
...
/datum/objective/hoard_mammons/update_explanation_text()
	explanation_text = "Accumulate at least [target_mammons] casings in your possession to demonstrate your greediness to Dismas."
