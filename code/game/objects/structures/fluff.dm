...
/obj/structure/fluff/globe/attack_hand(mob/user)
	...
	"You spin the globe!",
	"You land on Risena!",
	"You land on Phantom Island!",
	"You land on Glimmerfall!",
	"You land on Craterin!",
	"You land on Froza!",
	"You land on Zhaladusk!",
	"You land on No man's land!",
	"You land on Ancient Forest!",
	"You land on Shadow Island!",
	"You land on the ocean!",
	"You land on one of the islands!",)
...
/obj/structure/fluff/statue/evil
	name = "idol"
	desc = "A statue built to the robber-god, Dismas. The visage resembles nobody in particular. It is said that he grants the wishes of those pagan bandits (free folk) who feed him money."
	icon_state = "evilidol"
	icon = 'icons/roguetown/misc/structure.dmi'
