...
/obj/structure/fluff/globe/attack_hand(mob/user)
	...
	var/mob/living/carbon/human/H = user
	var/random_message = pick("You spin the globe!", "You land on Risena!", "You land on Phantom Kingdom!", "You land on Glimmerfall!", "You land on Craterin!", "You land on Frozen Empire!", "You land on Zhaladusk!", "You land on the Fog Islands!")
