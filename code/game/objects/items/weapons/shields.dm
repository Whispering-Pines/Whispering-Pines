...
/obj/item/weapon/shield/wood/choose_design(proc_value, mob/user)
	...
	var/picked_name = input(user, "Choose a Heraldry", "WHISPERING PINES", name) as null|anything in sortList(GLOB.IconStates_cache['icons/roguetown/weapons/wood_heraldry.dmi'])
	if(!picked_name)
		picked_name = "none"
...
/obj/item/weapon/shield/tower/metal/choose_design(proc_value, user)
	...
	var/picked_name = input(user, "Choose a Heraldry", "WHISPERING PINES", name) as null|anything in sortList(GLOB.IconStates_cache['icons/roguetown/weapons/shield_heraldry.dmi'])
	if(!picked_name)
		picked_name = "none"
