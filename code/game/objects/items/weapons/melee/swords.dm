...
/obj/item/weapon/sword/long/greatsword/ironclaymore
	...
	force_wielded = DAMAGE_LONGSWORD_WIELD
	name = "iron claymore"
	desc = "A large sword, scary to be in range of."
...
/obj/item/weapon/sword/long/exe
	...
	desc = "An ancient blade of ginormous stature, with a round ended tip. The pride and joy of Phantom Kingdom's greatest pastime, executions."
	minstr = 10
	slot_flags = ITEM_SLOT_BACK
