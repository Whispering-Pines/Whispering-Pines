/datum/migrant_role/gaoler
	name = "Gaoler"
	greet_text = "The lord of Phantom Kingdom sent you to Glimmerfall to rappatriate some prisoners that were in their prison, you are now on your way back."
...
/datum/migrant_role/mig_prisoner
	name = "Prisoner"
	greet_text = "You had fled Phantom Kingdom, took refuge in Glimmerfall yet the lords over there caught you and thus handed you over to those who seeked you before."
...
/datum/migrant_role/prisoner_guard
	name = "Guard"
	greet_text = "You are apart of a convoy returning prisoners to Phantom Kingdom. Obey the gaoler and ensure the prisoners get back to the dungeons."
...
/datum/migrant_wave/prisoner_convoy
	...
	greet_text = "Nobody escape the rule of Phantom Kingdom's monarchs. Some have fled to the neighbouring kingdom, Glimmerfall and got caught, they are now on their way back."
