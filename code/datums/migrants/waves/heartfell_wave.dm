...
/datum/migrant_wave/heartfelt_down_one
	...
	greet_text = "Fleeing disaster, you have come together as a court, united in a final effort to restore the former glory and promise of Glimmerfall. Stay close and watch out for each other, for all of your sakes! The journey took its heavy toll. Only you two made it, the rest..."
...
/datum/migrant_wave/heartfelt_down_two
	...
	greet_text = "Fleeing disaster, you have come together as a court, united in a final effort to restore the former glory and promise of Glimmerfall. But disaster followed hot on your heels, from Glimmerfall to this very place! You are the last one remaining, oh how tragic!"
