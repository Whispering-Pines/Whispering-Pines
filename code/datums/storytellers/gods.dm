...
/datum/storyteller/ravox
	...
	influence_sets = list(
		...
		"Set 3" = list(
			STATS_FOREST_DEATHS = list("name" = "Forest deaths:", "points" = -4, "capacity" = 90),
		),
		"Set 4" = list(
			STATS_PEOPLE_DROWNED = list("name" = "People drowned:", "points" = -4, "capacity" = 75),
		)
	)
...
/datum/storyteller/necra
	name = NECRA
	desc = "Death takes things very slow, rarely bringing in newcomers."
...
/datum/storyteller/eora
	...
	influence_sets = list(
		"Set 1" = list(
			STATS_SKILLS_DREAMED = list("name" = "Dreams had:", "points" = 8, "capacity" = 90),
		),
		"Set 2" = list(
