...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"Eyes of Dismas" = TRAIT_MATTHIOS_EYES,
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_GOODLOVER = span_love("It's a lucky thing to share my bed, I mastered the ways of the bed and can control my orgasm."),
